 ...
 * @author ksand
 */
@WebServlet(name = "mantenimientocarrera", urlPatterns = {"/mantenimientocarrera", "/carreras"})
public class controller_carrera extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet controller_carrera</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet controller_carrera at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("ver")) {
            ...
            request.getRequestDispatcher("mantenimientocarreras.jsp").forward(request, response);
            ...
            try {
                carreras_oferta = (List<carrera>) cDao.buscarCarrera_nombre(nombre);
           ...
           request.getRequestDispatcher("mantenimientocarreras.jsp").forward(request, response);
            ...
            try {
                carreras_oferta = (List<carrera>) cDao.buscarCarrera(codigo);
